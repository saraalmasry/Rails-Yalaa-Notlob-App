# -*- encoding: utf-8 -*-
# stub: activity_notification 1.7.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<mongoid>.freeze, [">= 4.0.0", "< 7.0.0"])
      s.add_development_dependency(%q<rspec-rails>.freeze, [">= 3.8.0"])
      s.add_development_dependency(%q<factory_bot_rails>.freeze, [">= 4.11.0"])
      ...
      s.add_dependency(%q<mongoid>.freeze, [">= 4.0.0", "< 7.0.0"])
      s.add_dependency(%q<rspec-rails>.freeze, [">= 3.8.0"])
      s.add_dependency(%q<factory_bot_rails>.freeze, [">= 4.11.0"])
